...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            skills: ["Linux/windows" , "Pentesting", "Password Cracking", "Metasploit", "Wireshark", "Nmap", "Splunk","Forensic tools","GPT/LLM"],
            projects: ["passLord", "FM Frequency Emulator", "PiJam: WiFi Disruptor", "Keylogger","Instagram clone"],
            interests: ["Blogging", "Volunteering", "IOT","Pentesting","Hacking","Investigation"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full">
                    <div className="flex">
                        <div className=" text-blue-500 ">navnee1h@kali</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/navnee1h")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-navnee1h, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-navnee1h":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-navnee1h");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-navnee1h, todoist, trash, settings, sendmsg ]";
                }
                break;
